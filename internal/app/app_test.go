...
func (fakeService) WritablePaths() []string { return []string{} }
...
func (b *blockingService) WritablePaths() []string { return []string{} }
...
func (c *cancelingService) WritablePaths() []string { return []string{} }
